...
See [the installation guide](/docs/get-started/download-and-install/reference/database#install-mysql-connector) for additional information and instructions.
