...
* Set up or use an administrative identity server, such as a second instance of FusionAuth, Google Workspace, or Microsoft Entra ID, and have these users log in using that.
