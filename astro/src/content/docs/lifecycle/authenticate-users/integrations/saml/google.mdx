...
* <InlineField>Issuer</InlineField> : <InlineFieldValue>google.com</InlineFieldValue>
* <InlineField>Audience</InlineField> : Leave blank
* <InlineField>Callback URL (ACS)</InlineField> : <InlineFieldValue>https://accounts.google.com/a/YOUR_G_SUITE_DOMAIN/acs</InlineFieldValue>
...
On the Security settings page, scroll down and open the <InlineUIElement>Set up single sign-on</InlineUIElement> section.
...
Scroll down to the <InlineUIElement>SAML v2 Integration details</InlineUIElement> section; here are the settings you need to copy and paste:
