...
description: Configure SAML v2 for Microsoft Entra ID (formerly Azure AD).
section: lifecycle
...
Navigate to your Microsoft Entra ID application. Under step one, click on the pencil to edit.
...
Before you can complete your integration, assign Microsoft Entra ID users to your Microsoft Entra ID application. Add a user by navigating to <Breadcrumb>Users and groups</Breadcrumb> and clicking on the <InlineUIElement>Add user/group</InlineUIElement> button. Follow the instructions to select and add a user.
