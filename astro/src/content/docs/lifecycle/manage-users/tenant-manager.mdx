...
3. Open the <Breadcrumb>Registrations</Breadcrumb> tab and click <InlineUIElement>Add a registration</InlineUIElement>
...
The <InlineUIElement>Basic information</InlineUIElement> section contains a form for setting user properties. To customize the properties in the Basic information section:
