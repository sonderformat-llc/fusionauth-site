...
We strongly recommend using the **Client Credentials grant** over a static authorization header. This method is supported by major identity providers and offers several advantages:
...
If your SCIM client does not support the Client Credentials grant, you can manually generate a long-lived token by following these steps:
