...
* **Significant Security Risk**: Because the token must be long-lived to avoid frequent manual updates, it essentially becomes a static API key. If this token is leaked, it provides persistent access to your SCIM endpoints.
