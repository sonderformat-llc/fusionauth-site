...
Then, run the command below, with the value of <InlineFieldValue>YOUR_CLIENT_SECRET</InlineFieldValue> updated to the real value, such as `i2kN2KFBPKKj3FsxfilPXDDreBUskn2Sl-27QbQRYQM`.
