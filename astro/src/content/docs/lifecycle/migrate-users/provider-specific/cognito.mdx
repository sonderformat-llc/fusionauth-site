...
This document will help you migrate your users off of Amazon Cognito. If you are looking to compare FusionAuth and Cognito, [this document may help](/blog/amazon-cognito-and-fusionauth-comparison).
...
<OneTenantOrMany migration_source_name={migration_source_name} external_tenant_name="User Pool" external_tenant_name_plural="User Pools" />
