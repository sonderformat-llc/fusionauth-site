...
<APIBlock>
  <APIField name="consent.consentEmailTemplateId" type="UUID">
    The Id of the Email Template that is used to send confirmation to the end user.
  </APIField>
  <APIField name="consent.countryMinimumAgeForSelfConsent" type="Map<Locale, Integer>">
  ...
  <APIField name="consent.data" type="Object">
    An object that can hold any information about the Consent that should be persisted.
  </APIField>
  <APIField name="consent.defaultMinimumAgeForSelfConsent" type="Integer">
  ...
  <APIField name="consent.emailPlus.enabled" type="Boolean">
  ...
  <APIField name="consent.name" type="String">
    The unique name of the consent.
  </APIField>
  <APIField name="consent.values" type="Array<String>">
    One or more values that may be assigned for this consent.
  </APIField>
</APIBlock>

<JSON title="Example Response JSON" src="consents/response.json" />
