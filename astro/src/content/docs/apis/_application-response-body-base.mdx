...
<APIBlock>
  ...
  <APIField name={ props.base_field_name + ".oauthConfiguration.clientSecret" } type="String" renderif={!props.search_result}>
    The OAuth client secret.
  </APIField>
  <APIField name={ props.base_field_name + ".oauthConfiguration.consentMode" } type="String" since="1.50.0">
    Controls the policy for prompting a user to consent to requested OAuth scopes. This configuration only takes effect when <InlineField>{props.base_field_name + ".oauthConfiguration.relationship"}</InlineField> is <InlineFieldValue>ThirdParty</InlineFieldValue>.
  ...
  <APIField name={ props.base_field_name + ".registrationConfiguration.preferredLanguages.enabled" } type="Boolean" since="1.47.0">
    Determines if the <InlineField>preferredLanguages</InlineField> field will be included on the registration form.
  </APIField>
  ...
  <APIField name={ props.base_field_name + ".universalConfiguration.universal" } type="Boolean" optional since="1.58.0">
  ...
  <APIField name="expandable" type="Array<String>" since="1.50.0" renderif={!!props.search_result}>
    ...
    For example, if you set the <InlineField>expand</InlineField> request parameter to `[roles]` then the value of this parameter in the response will be `[scopes]` indicating that the <InlineField>scopes</InlineField> property was not expanded.
  </APIField>
