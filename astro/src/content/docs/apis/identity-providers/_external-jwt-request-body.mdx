...
<APIBlock>
  ...
  <APIField name="identityProvider.oauth2.emailClaim" type="String" optional defaults="email">
    The name of the claim that contains the user's email address. This will only be used when the <InlineField>identityProvider.linkingStrategy</InlineField> is equal to <InlineFieldValue>LinkByEmail</InlineFieldValue> or <InlineFieldValue>LinkByEmailForExistingUser</InlineFieldValue>.
  </APIField>
  <APIField name="identityProvider.oauth2.emailVerifiedClaim" type="String" optional defaults="email_verified" since="1.48.0">
    ...
    When the <InlineField>identityProvider.linkingStrategy</InlineField> is equal to <InlineFieldValue>LinkByEmail</InlineFieldValue> or <InlineFieldValue>LinkByEmailForExistingUser</InlineFieldValue> and this claim is present and the value is `false` a link will not be established and an error will be returned indicating a link cannot be established using an unverified email address.
  </APIField>
  ...
  <APIField name="identityProvider.oauth2.usernameClaim" type="String" optional defaults="preferred_username">
    The name of the claim that contains the user's username. This will only be used when the <InlineField>identityProvider.linkingStrategy</InlineField> is equal to <InlineFieldValue>LinkByUsername</InlineFieldValue> or <InlineFieldValue>LinkByUsernameForExistingUser</InlineFieldValue>.
  </APIField>
