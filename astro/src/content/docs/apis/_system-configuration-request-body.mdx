...
<APIBlock>
  <APIField name="systemConfiguration.auditLogConfiguration.delete.enabled" type="Boolean" optional defaults="false">
  ...
  <APIField name="systemConfiguration.auditLogConfiguration.delete.numberOfDaysToRetain" type="Integer" optional defaults="365">
    ...
    Prior to version `1.30.0`, this value was required when <InlineField>delete.enabled</InlineField> was equal to `true`.
  </APIField>
  <APIField name="systemConfiguration.corsConfiguration.allowCredentials" type="Boolean" optional defaults="false">
  ...
  <APIField name="systemConfiguration.corsConfiguration.allowedHeaders" type="Array<String>" optional>
  ...
  <APIField name="systemConfiguration.corsConfiguration.debug" type="Boolean" optional defaults="false">
  ...
  <APIField name="systemConfiguration.corsConfiguration.enabled" type="Boolean" optional defaults="false">
    Whether the FusionAuth CORS filter will process requests made to FusionAuth.
  </APIField>
  <APIField name="systemConfiguration.corsConfiguration.exposedHeaders" type="Array<String>" optional>
  ...
  <APIField name="systemConfiguration.corsConfiguration.preflightMaxAgeInSeconds" type="Integer" optional>
  ...
  <APIField name="systemConfiguration.data" type="Object" optional>
    An object that can hold any information about the System that should be persisted.
  </APIField>
  <APIField name="systemConfiguration.eventLogConfiguration.numberToRetain" type="Integer" optional>
  ...
  <APIField name="systemConfiguration.loginRecordConfiguration.delete.enabled" type="Boolean" optional defaults="false">
  ...
  <APIField name="systemConfiguration.loginRecordConfiguration.delete.numberOfDaysToRetain" type="Integer" optional defaults="365">
  ...
  <APIField name="systemConfiguration.trustedProxyConfiguration.trusted" type="Array<String>" since="1.49.0">
    An array of IP addresses, representing the set of trusted upstream proxies. This value will be accepted but ignored when <InlineField>systemConfiguration.trustedProxyConfiguration.trustPolicy</InlineField> is set to <InlineFieldValue>All</InlineFieldValue>.
  ...
  <APIField name="systemConfiguration.webhookEventLogConfiguration.enabled" type="Boolean" optional defaults="true" since="1.57.0">
  ...
  <APIField name="systemConfiguration.webhookEventLogConfiguration.delete.enabled" type="Boolean" optional defaults="true" since="1.53.0">
    Whether or not FusionAuth should delete Webhook Event Logs based upon this configuration. When `true` the <InlineField>webhookEventLogConfiguration.delete.numberOfDaysToRetain</InlineField> value will be used to identify webhook event logs that are eligible for deletion. When this value is set to `false` webhook event logs will be preserved forever.
