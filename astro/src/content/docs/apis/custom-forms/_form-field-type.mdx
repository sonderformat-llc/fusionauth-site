 ...
 * <InlineFieldValue>date</InlineFieldValue> the value will be stored as a date. The value must be formatted as ISO-8601 or <InlineField>YYY-MM-DD</InlineField>, you may want to use a JavaScript data picker that can convert the selected value to this format.
