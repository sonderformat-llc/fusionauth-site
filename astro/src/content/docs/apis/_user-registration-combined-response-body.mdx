...
<APIBlock>
  ...
  <APIField name="user.verified" type="Boolean">
    ...
    <APIField name="verificationIds" type="Array" since="1.62.0">
    ...
    <APIField name="verificationIds[x].id" type="String" since="1.62.0">
    ...
    <APIField name="verificationIds[x].oneTimeCode" type="String" since="1.62.0">
    ...
    <APIField name="verificationIds[x].type" type="String" since="1.62.0">
    ...
    <APIField name="verificationIds[x].value" type="String" since="1.62.0">
...
<JSON title="Example Response JSON" src="user-registrations/combined-response-create.json" />
