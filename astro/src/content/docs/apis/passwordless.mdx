...
<Aside type="caution" title="Deprecated usage">
  ...
  * Passwordless login with phone numbers, introduced in version `1.59.0`, is not supported by this usage of this API endpoint. Use the [Start Passwordless Login](#start-passwordless-login) API to obtain a code and then provide that code to this API (see above).
</Aside>
