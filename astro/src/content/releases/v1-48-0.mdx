...
When the OpenID Connect or External JWT Identity Provider is configured to Link by Email and the IdP returns a claim named <InlineField>email_verified</InlineField> and the value is <InlineFieldValue>false</InlineFieldValue>, the link request will be rejected. This change is intended to reduce the risk of linking on an un-verified email address.
</Item>
