...
In the event that the user has never seen the login page, the value of the <InlineField>rememberDevice</InlineField> query parameter will be the deciding factor. A value of <InlineFieldValue>true</InlineFieldValue> indicates that an SSO session should be created and a value of <InlineFieldValue>false</InlineFieldValue> indicates that an SSO session should not be created. If this parameter is omitted, the default behavior will be to create the SSO session.
